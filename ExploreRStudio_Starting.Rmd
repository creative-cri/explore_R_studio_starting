...
temps_f <- c(62,63,62,61,61,60,60)
temps_f
...
possible_destionations <- list(wellington = temps_f, moscow=c(69,73,54,56,53,58,59), cape_town=c(79,74,70,68,72,68,72))
possible_destionations 
...
nice_cities <- lapply(possible_destionations, is_nice_weather)
nice_cities
...
library(ggplot2)
destination_df = as.data.frame(possible_destionations)
ggplot(stack(destination_df), aes(x= ind, y=values)) + geom_boxplot() + labs(x='Cities', y='Temperatures') + ggtitle('City Temperatures')
